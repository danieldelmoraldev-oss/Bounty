...
retos ✅, 4) Cámara libre y álbum ✅, 5) Economía y tienda ✅, 6) Recaps ✅
(visor tipo stories con las mejores fotos y estadísticas de cada fiesta,
sin vídeo real exportable todavía), 7) Preparación de release (EAS build +
Play Store) — **antes de esta**, toca la comprobación final de todo junto.
